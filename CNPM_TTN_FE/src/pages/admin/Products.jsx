...
export default function AdminProducts() {
  ...
  const fetchData = async () => {
    try {
      ...
      const [resProd, resCat] = await Promise.all([
        API.getAll(searchTerm, selectedCategories, minPrice, maxPrice, status),
        API.getCategories(),
      ]);
  ...
  useEffect(() => {
    fetchData();
  }, [searchTerm, selectedCategories, minPrice, maxPrice, status]);
                ...
                filteredProducts.map((prod) => (
                  ...
                  >
                    <td className="px-6 py-4">
                      <img
                        src={`http://localhost:5126${prod.imageUrl}`}
                    ...
                    <td className="px-6 py-4">
                      <div className="flex items-center justify-center gap-2">
                        <button
                          onClick={() => handleOpenModal("view", prod)}
          ...
          <div className="bg-white rounded-3xl w-full max-w-4xl max-h-[90vh] overflow-y-auto shadow-2xl">
            ...
            <form onSubmit={handleSubmit} className="p-8 space-y-8">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                <div className="space-y-3">
                  ...
                  <div className="relative group aspect-square border-2 border-dashed border-gray-200 rounded-2xl flex items-center justify-center overflow-hidden bg-gray-50">
                    {formData.imageUrl ? (
                      <img
                        src={`http://localhost:5126${formData.imageUrl}`}
              ...
              <div className="pt-6 border-t">
                <h3 className="text-md font-bold text-primary mb-4">
                  Thông số chi tiết (Product Details)
                </h3>
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                  <div>
                    ...
                    <input
                      ...
                      value={formData.productDetail.region}
                      onChange={(e) =>
                        setFormData({
                          ...formData,
                          productDetail: {
                  ...
                  <div>
                    ...
                    <input
                      ...
                      type="text"
                      className="w-full p-2 border rounded-lg mt-1"
                      value={formData.productDetail.process}
                      onChange={(e) =>
                        setFormData({
                          ...formData,
                          productDetail: {
                  ...
                  <div>
                    ...
                    <input
                      ...
                      type="text"
                      className="w-full p-2 border rounded-lg mt-1"
                      value={formData.productDetail.roast}
                      onChange={(e) =>
                        setFormData({
                          ...formData,
                          productDetail: {
                  ...
                  <div className="md:col-span-3">
                    ...
                    <input
                      ...
                      type="text"
                      className="w-full p-2 border rounded-lg mt-1"
                      value={formData.productDetail.flavorNotes}
                      onChange={(e) =>
                        setFormData({
                          ...formData,
                          productDetail: {
                  ...
                  {/* MỨC ĐỘ 1-5 */}
                  {["acidityLevel", "bitternessLevel", "bodyLevel"].map(
                    (level) => (
                      <div key={level}>
                        ...
                        <input
                          ...
                          max="5"
                          className="w-full p-2 border rounded-lg mt-1"
                          value={formData.productDetail[level]}
                          onChange={(e) =>
                            setFormData({
                              ...formData,
                              productDetail: {
              ...
              {modalMode !== "view" && (
                <div className="flex justify-end gap-4 pt-6 border-t">
                  <button
                    type="button"
                    onClick={() => setIsModalOpen(false)}
                    className="px-6 py-2.5 border rounded-xl font-bold text-gray-600"
                  >
                    Hủy
                  </button>
                  <button
                    type="submit"
                    className="px-8 py-2.5 bg-primary text-white rounded-xl font-bold hover:bg-accent-1 transition-all"
                  >
